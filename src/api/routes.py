...
def register():
    ...
    if not names or not lastname or not email or not password:
    ...
    new_user = User(names=names, lastname=lastname, email=email, password=hashed_password, is_active=False)
